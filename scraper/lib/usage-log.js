 ...
 *
 * 【何のための記録か】
 * このリポジトリの日次パイプラインは、厚労省データの取り込みと、公式サイトの推定・
 * 構造化（Haiku）で Claude API を呼んでいる。どこにいくらかかっているかを
 ...
 *   [{ "date": "2026-09-09", "script": "enrich-mhlw-websites", "model": "claude-sonnet-4-6",
...
/** 実行中のスクリプト名（structure.js → "structure"）。 */
